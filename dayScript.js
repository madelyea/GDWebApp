...
// get the date and open the search
var today = new Date();
// need to convert month number to name, could use moment instead
var months = ["january", "february", "march", "april", "may", "june",
    "july", "august", "september", "october", "november", "december"];

request.open('GET', 'https://archive.org/metadata/' + months[today.getMonth()] + ("0" + today.getDate()).slice(-2).toString() + '_' + today.getFullYear().toString() + '10/files', true);
console.log('https://archive.org/metadata/' + months[today.getMonth()] + ("0" + today.getDate()).slice(-2).toString() + '_' + today.getFullYear().toString() + '10/files');
